...
Aparte, la aplicación se encuentra disponible en [visualizaciones-congreso.lc-ip81.inf.utfsm.cl](visualizaciones-congreso.lc-ip81.inf.utfsm.cl) y la interfaz gráfica de GraphQL en [datos-congreso.lc-ip81.inf.utfsm.cl](datos-congreso.lc-ip81.inf.utfsm.cl).